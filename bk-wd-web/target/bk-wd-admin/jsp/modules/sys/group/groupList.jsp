        ...
        <div class="organization">
            ...
            <div class="left_wrap">
                <div class="role_list">
                    <h3>
                        <p>群组列表</p>
                        <shiro:hasPermission name="sys:group:edit"><span class="add"></span></shiro:hasPermission>
                    </h3>
                    <ul>
                        <c:forEach items="${list}" var="data" varStatus="status">
                            <li>
                                <p class="${0 == status.index ? 'cur' : ''}" data-id="${data.id}">
                                    ${data.name}<span class="cat">${fns:getDictLabel(data.category , 'user_group_category', '')}</span>
