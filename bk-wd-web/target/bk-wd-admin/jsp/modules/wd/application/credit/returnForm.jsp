...
<body>
                ...
                <div class="x_content">
                    <form id="submit-module" data-parsley-validate class="form-horizontal form-label-left">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9 col-xs-9" >
                                <select class="form-control" name="reason">
                                      <option value="授权日期超时">授权日期超时</option>
                                      <option value="征信授权书被涂改">征信授权书被涂改</option>
                                      <option value="照片模糊">照片模糊</option>
                                      <option value="企业营业执照不合规">企业营业执照不合规</option>
                        ...
                        <div class="form-group" id="remarksDiv" style="display: none;">
                            <label class="control-label col-md-3 col-xs-3" for="moduleCode">
                                                        驳回原因补充<span class="required"></span>
                            </label>
                            <div class="col-md-9 col-xs-9">
                                <textarea name="remarks" style="width: 60%;" class="form-control2 col-md-9 col-xs-9" rows="10"></textarea>
                                <div class="warning hide">
                                    <ins class="import"></ins>
                                    <span class="hide"><i>不能为空</i></span>
                                </div>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
        	$("#submit-module :input[name=reason]").on("change", function(){
        		if ("其他" == $(this).val()) {
        			$("#remarksDiv").show();
        		} else {
        			$("#remarksDiv").hide();
        			$("#submit-module :input[name=remarks]").val("");
        		}
        	});
            ...
            $("#submit-add-module").click(function (event) {
            	...
            	$.ajax({
                    url: "${ctx}/wd/application/credit/return",
                    async: false,
                    cache: false,
                    type: "POST",
