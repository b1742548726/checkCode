			...
			<div class="x_content">
				<div id="resolution">
					...
					<table>
						...
						<tbody>
							<tr>
								<td colspan="50" class="center bold large height">
									大石桥农商微贷中心审贷会决议表
								</td>
							</tr>
							...
							<tr>
								<td colspan="6" rowspan="${ approvedInfoRowSpan + 7 }" class="bold">批准贷款申请</td>
								<td colspan="7"
							...
							<tr>
								...
								<td colspan="23">${ resolution.managers }</td>
								<td colspan="6" class="bold">分管行长签名</td>
								<td colspan="15"></td>
							</tr>
							<tr>
								<td colspan="6">日期</td>
								<td colspan="44"><fmt:formatDate
										value="${ resolution.approvedDate }"
										pattern="yyyy-MM-dd HH:mm:ss" /></td>
							</tr>
							<tr>
								<td colspan="50" class="center bold">用信审查表</td>
							</tr>
							
							<tr>
								<td colspan="10">用信贷款种类</td>
								<td colspan="15"></td>
								<td colspan="10">申请用信期限</td>
								<td colspan="15"></td>
							</tr>
							<tr>
								<td colspan="10">申请用信金额</td>
								<td colspan="15"></td>
								<td colspan="10">约定的贷款支付方式</td>
								<td colspan="15">□ 自主支付&nbsp;&nbsp;□ 受托支付</td>
							</tr>
							<tr>
								<td colspan="10">申请用信时借款用途</td>
								<td colspan="40"></td>
							</tr>
							<tr>
								<td colspan="10">申请用信担保措施</td>
								<td colspan="40">
									□ 抵押 &nbsp;&nbsp; 
									□ 质押 &nbsp;&nbsp; 
									□ 保证 &nbsp;&nbsp; 
							...
							<tr>
								<td colspan="28">利率是否符合制度规定</td>
								<td colspan="22">□ 是 &nbsp;&nbsp; □ 否 &nbsp;&nbsp; 情况说明：</td>
							</tr>
							<tr>
								<td colspan="28">授信要求的担保措施是否落实</td>
								<td colspan="22">□ 是 &nbsp;&nbsp; □ 否 &nbsp;&nbsp; 情况说明：</td>
							</tr>
							<tr>
								<td colspan="28">合同要素是否完整、有效，与授信审批的担保措施、金额是否一致</td>
								<td colspan="22">□ 是 &nbsp;&nbsp; □ 否 &nbsp;&nbsp; 情况说明：</td>
							</tr>
							
							<tr>
								<td colspan="50" class="center">用信审批</td>
							</tr>
	...
	<script type="text/javascript">
		$(function() {
			...
			$("#btnWrodExport").click(function() {
				location.href = "${ctx}/wd/application/print/resolutionWordExport?applicationId=${applicationId}";
			});
