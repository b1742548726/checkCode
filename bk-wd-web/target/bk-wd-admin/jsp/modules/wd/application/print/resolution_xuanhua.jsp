					...
					<table>
						...
						<tbody>
							...
							<tr>
								...
								<td colspan="11">年利率：${ resolution.finalRate }</td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td colspan="9" class="center">成员一</td>
								<td colspan="9" class="center">成员二</td>
								<td colspan="9" class="center">成员三</td>
								<td colspan="9" class="center">成员四</td>
								<td colspan="8" class="center">成员五</td>
							</tr>
							<tr>
								<td colspan="5">□ 同意</td>
								<td colspan="4">□ 拒绝</td>
	...
	<script type="text/javascript">
		$(function() {
			...
			$("#btnWrodExport").click(function() {
				location.href = "${ctx}/wd/application/print/resolutionXuanhuaWordExport?applicationId=${applicationId}";
			});
		});
