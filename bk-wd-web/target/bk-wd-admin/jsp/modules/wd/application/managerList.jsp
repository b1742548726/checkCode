    ...
    <div class="wd-content">
        ...
        <div class="wd-piece-content col-md-12 col-sm-12 col-xs-12">
            <div class="list-page-search-div col-xs-12">
                <form action="${ctx}/wd/application/managerList" id="searchForm" method="get">
                    <div class="col-md-12 col-sm-12 col-xs-12" style="margin-bottom: 1em;">
                        ...
                        <div class="col-xs-2">
                            <span class="col-xs-12"> 身份证号码 </span>
                            <div class="col-xs-11">
                                <div class="auto-clear-input">
                        ...
                        <div class="col-xs-2">
                            <span class="col-xs-11"> 责任人 </span>
                            <div class="col-xs-11">
                                <div class="auto-clear-input">
                                    <input type="text" class="form-control" name="taskUserName" value="${params.taskUserName }" />
                                </div>
                            </div>
                        </div>
                ...
                <table class="category-table" name="application-status" id="category-status-table">
                    <tbody>
                        <tr>
                            ...
                            <td value="64"> <span> 资料初审 </span><i>${analyzeData.offlineFirstReview }</i> </td>
                            <td value="8"> <span> 资料审查 </span><i>${analyzeData.offlineReview }</i> </td>
                            <td value="128"> <span> 风险核实 </span><i>${analyzeData.riskHeshi }</i> </td>
                            <td value="16"> <span> 表格审查 </span><i>${analyzeData.tableReview }</i> </td>
                            <td value="32"> <span> 风控审批 </span><i>${analyzeData.riskControl }</i> </td>
                            <td value="256"> <span> 超额审批 </span><i>${analyzeData.extendReview }</i> </td>
                            <td value="512"> <span> 待放款 </span><i>${analyzeData.loanReview }</i> </td>
                ...
                <table class="table table-striped table-bordered wd-table" id="appliaction-list">
                    <thead>
                        <tr>
                            ...
                            <th style="width: 132px;"> 已花费时间 </th>
                            <th style="width: 132px;"> 当前状态 </th>
                            <th style="width: 132px;"> 责任人</th>
                    ...
                    <tbody>
                        <c:forEach items="${pagination.dataList }" var="application">
                            <tr>
                                ...
                                <td>${application.wdApplicationTask.statusName}</td>
                                <td title="${application.wdApplicationTask.ownerName}">${application.wdApplicationTask.ownerName}</td>
                                <td>
