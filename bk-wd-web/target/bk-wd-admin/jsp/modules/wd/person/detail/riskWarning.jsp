    ...
    <div class="wd-content">
        <div class="left_info">
            ...
            <ul class="client_detail_tab">
                <li><a href="${ctx }/wd/person/detail/index?personId=${personId}">客户信息</a></li>
            ...
            <c:if test="${empty wdRwZmCreditAntifraudVerifyList and empty shixinList and empty zhixinList and empty wdRwEmaySinowayCreditList}">
                <div class="nodata">
                    <img src="${imgStatic }/zwy/LBQ/images/icn_gray_risk.png" alt="">
                    <h3>抱歉，暂无任何风险提示数据！</h3>
                    <p>说明：本页面会展示客户的失信被执行人、被执行人、欺诈信息验证、裁判文书、他人担保人、他人共同借款人等风险信息！</p>
                </div>
            </c:if>
        </div>
    </div>
