...
<input type="text" id="${name}" name="${name}" maxlength="5" class="verification-code required form-control" />
<span class="verification-code">
	...
	<a href="javascript:" onclick="$('.${name}').attr('src','${pageContext.request.contextPath}/servlet/validateCodeServlet?'+new Date().getTime());" class="mid ${name}Refresh">刷新</a>
</span>