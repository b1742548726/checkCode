...
<body>
    <div class="wd-content">
        <div class="popupHtml2">
            ...
            <div class="popMiddle" style="width:10%;"><i></i></div>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $('.save').on('click',function(){
            	...
            	var _office_name = $("#organ_list .cur").children("span").text();
            	SetLayerData("_user_office_id_select", {id : _office_id , name : _office_name});
            	CloseIFrame();
            })

            Module.init()
            $("#organ_list [data-id=${officeId }]").trigger("click");
        });
