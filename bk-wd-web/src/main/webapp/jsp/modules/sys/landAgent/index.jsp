...
<body>
     <div id="id_scoreModuleList" class="wd-content land_agent">
        <div class="wd-piece-content col-md-12 col-sm-12 col-xs-12">
            ...
            <div name="div_headLabel" class="div_headLabel">
            	<div class="wd-piece-title"><h2 style="font-weight: 600;">房地产开发商管理</h2></div>
                			...
                			<div class="soft_left">								
								<ul class="si_list">
	                    			<li>
	                    				...
	                    				<label>开发商<span>*拖动列表可排序</span></label>
    ...
    var currentPageUrl = {
		list : "${ctx}/sys/landagent/list",
		save : "${ctx}/sys/landagent/save",
		del : "${ctx}/sys/landagent/del",
		sort: "${ctx}/sys/landagent/sort",
		getChild : "${ctx}/sys/landagent/getChild"
    }
    </script>
    
    <script src="${imgStatic }/zwy/js/ajax.js"></script>
    <script src="${imgStatic }/zwy/js/house.js"></script>
