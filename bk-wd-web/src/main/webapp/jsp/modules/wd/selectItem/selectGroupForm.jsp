...
<body>
            ...
            <div class="x_panel">
                ...
                <div class="x_content">
                    <form id="form-add-select" data-parsley-validate class="form-horizontal form-label-left">
                        <input type="hidden" id="hidden-groupId" name="id" value="${wdSelectGroup.id }">
                        <div class="form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="selectName">
                                名称 <span class="required">*</span>
                            </label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="text" id="selectName" value="${wdSelectGroup.name }" name="name" required="required" class="form-control col-md-7 col-xs-12">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input type="text" id="selectCode" value="${wdSelectGroup.code }" name="code" required="required" class="form-control col-md-7 col-xs-12">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="selectRemarks">说明</label>
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <textarea id="selectRemarks" name="remarks" class="form-control col-md-7 col-xs-12" rows="4">${wdSelectGroup.remarks }</textarea>
                            </div>
                        </div>
                    </form>
                </div>
    ...
    <script type="text/javascript">
        function setSelectGroupValue(id) {
            var addselect = { "name": $("#selectName").val(), "code": $("#selectCode").val(), "id": id };
            SetLayerData("AddOneSelectGroup", addselect);
        }

        $(document).ready(function () {
            $("#cancle-add-select").click(function (event) {
                SetLayerData("AddOneSelectGroup", null);
                CloseIFrame();
            });
            ...
            $("#submit-add-select").click(function (event) {
                ...
                if (formParsley.validate()) {
                    ...
                    $.ajax({
        				url : "${ctx}/wd/selectItem/editSelectGroup",
        				data : $("#form-add-select").serialize(),
        				type: "post",
        				success : function (data){
        					if (data.code == 200) {
    		                    setSelectGroupValue(data.data.id);
    		                    CloseIFrame();
        					}
        				}
        			})
