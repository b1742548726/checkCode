...
<body>
    ...
    <div class="wd-content">
        ...
        <div class="wd-piece-content col-md-12 col-sm-12 col-xs-12">
            <form action="${ctx}/wd/application/canceledList" id="searchForm" method="get">
                ...
                <div class="list-page-search-div col-xs-12">
                    ...
                    <div class="col-md-2 col-sm-2 col-xs-12">
                        <div class="col-xs-12">
                            <span class="col-xs-12"> 终止原因 </span>
                            <div class="col-xs-12">
                                <select class="form-control" name="stopCause">
                                    <option value="">请选择</option>
                                    <option value="申请人暂无资金需求" ${params.stopCause eq '申请人暂无资金需求' ? 'selected' : '' }>申请人暂无资金需求</option>
                                    <option value="申请信息错误" ${params.stopCause eq '申请信息错误' ? 'selected' : '' }>申请信息错误</option>
                                    <option value="更换借款人" ${params.stopCause eq '更换借款人' ? 'selected' : '' }>更换借款人</option>
                                    <option value="不符合现行准入标准" ${params.stopCause eq '不符合现行准入标准' ? 'selected' : '' }>不符合现行准入标准</option>
                                    <option value="决议超过有效期" ${params.stopCause eq '决议超过有效期' ? 'selected' : '' }>决议超过有效期</option>
                                    <option value="其他" ${params.stopCause eq '其他' ? 'selected' : '' }>其他</option>
                                </select>
                            </div>
                        </div>
                    </div>
            ...
            <div class="x_content">
                <table class="table table-striped table-bordered text-center wd-table" id="appliaction-list">
                    <thead>
                        <tr>
