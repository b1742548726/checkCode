...
<body>
		...
		<div class="wd-piece-content col-md-12 col-sm-12 col-xs-12">
			<div class="x_title non_bottom_border">
				...
				<ul class="nav navbar-right panel_toolbox">
					<li>
						<button type="button" class="btn wd-btn-normal wd-btn-width-middle" id="btn-back" style="margin-right: 0px;">返回</button>
					</li>
					<li>
	...
	<script type="text/javascript">
		...
		// 写上真是的地址
		var currentPageUrl = {
			editFrom : "${ctx}/customer4c/from/form"
		};
		...
		$(document).ready(function() {
			...
			$("#btn-back").click(function() {
				location.href = "${ctx}/customer4c/product/list";
			});

			$(".btn[fromid]").click(function() {
				var fromid = $(this).attr("fromid");
				window.open("${ctx}/customer4c/from/DRCode?id=" + fromid);
			});
